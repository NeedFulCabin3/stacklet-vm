...
A lean, minimal virtual machine implemented in Python that combines an internal data stack with a primary working register. It parses and executes simple text-based assembly commands out of a file or an array of strings. 
